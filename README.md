...
> As of **gnucobol-rs 0.8.12** (2026-06): **13/13 `libcob` files** ported 1:1 · **110/110 intrinsics** in the runtime · **137 sealed courts** · MSRV **1.74**. The living current-state authority is [`STATUS.md`](STATUS.md) — when it disagrees with this page, it wins.
...
> **As of gnucobol-rs 0.8.12 (2026-06):** 13/13 `libcob` files ported 1:1 · 110/110 intrinsics in the runtime · 137 sealed courts.
...
```sh
bash lab/oracle/cobol_frontend_sweep.sh     # 138-program byte sweep, gate FAIL=0
```
