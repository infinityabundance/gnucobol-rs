...
fn place() -> Vec<(i64, &'static str)> {
    let l2 = ["GNURUST.2","GNURUST.3","GNURUST.4","GNURUST.5","GNURUST.6","GNURUST.8","GNURUST.9","GNURUST.10","GNURUST.11","GNURUST.INTRINSIC.LENGTH.1","GNURUST.INTRINSIC.NUMVAL.1","GNURUST.INTRINSIC.NUMVAL-C.1","GNURUST.INTRINSIC.MOD-REM.1","GNURUST.INTRINSIC.INTEGER.1","GNURUST.INTRINSIC.CASE.1","GNURUST.INTRINSIC.ORD-CHAR.1","GNURUST.INTRINSIC.DATE.1","GNURUST.14","GNURUST.15","GNURUST.16","GNURUST.16C","GNURUST.17","GNURUST.18"];
    let l3 = ["GNURUST.7","GNURUST.13","GNURUST.19","GNURUST.REMAINDER.1","GNURUST.FILE.SEQUENTIAL.1","GNURUST.FILE.WRITE.1","GNURUST.FILE.REWRITE.1","GNURUST.12","GNURUST.12B","GNURUST.INITIALIZE.1","GNURUST.INSPECT.1","GNURUST.STRING.UNSTRING.1","GNURUST.ACCEPT.DISPLAY.1","GNURUST.ACCEPT.DISPLAY.2","GNURUST.SIZE.ERROR.1"];
    ...
    let l6 = ["GNURUST.IF.EVALUATE.SLICE.1","GNURUST.IF.NUMERIC.SLICE.1","GNURUST.PERFORM.SLICE.1","GNURUST.TABLE.PERFORM.SLICE.1","GNURUST.SEARCH.TABLE.1","GNURUST.FILE.FLOW.SLICE.1","GNURUST.FILE.FILTER.SLICE.1"];
    let mut v = Vec::new();
