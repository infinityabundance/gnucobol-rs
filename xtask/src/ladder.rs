...
fn place() -> Vec<(i64, &'static str)> {
    ...
    let l3 = ["GNURUST.7","GNURUST.13","GNURUST.19","GNURUST.REMAINDER.1","GNURUST.ROUND.1","GNURUST.BIGNUM.1","GNURUST.INTPOW.1","GNURUST.FILE.SEQUENTIAL.1","GNURUST.FILE.WRITE.1","GNURUST.FILE.REWRITE.1","GNURUST.FILEIO.LINESEQ.1","GNURUST.FILEIO.LINESEQ.2","GNURUST.FILEIO.SEQ.1","GNURUST.FILEIO.RELATIVE.1","GNURUST.FILEIO.SORT.1","GNURUST.FILEIO.SORTENGINE.1","GNURUST.FILEIO.MAPPING.1","GNURUST.MLIO.GENERATE.1","GNURUST.MLIO.PARSE.1","GNURUST.12","GNURUST.12B","GNURUST.INITIALIZE.1","GNURUST.INSPECT.1","GNURUST.REFMOD.1","GNURUST.STRING.UNSTRING.1","GNURUST.ACCEPT.DISPLAY.1","GNURUST.ACCEPT.DISPLAY.2","GNURUST.SIZE.ERROR.1"];
