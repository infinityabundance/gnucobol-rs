...
fn place() -> Vec<(i64, &'static str)> {
    ...
    let l6 = ["GNURUST.IF.EVALUATE.SLICE.1","GNURUST.IF.NUMERIC.SLICE.1","GNURUST.PERFORM.SLICE.1","GNURUST.TABLE.PERFORM.SLICE.1","GNURUST.SEARCH.TABLE.1","GNURUST.SUBSCRIPT.1","GNURUST.FILE.FLOW.SLICE.1","GNURUST.FILE.FILTER.SLICE.1"];
    let mut v = Vec::new();
