...
pub fn registry() -> Vec<Entry> {
    vec![
        ...
        e("-MP", &["-MP"], OptionPolicy::Translated, OptCategory::OutputSelection, false,
          "phony targets for every dependency (upstream 49da19a3d)"),
        e("-MD", &["-MD"], OptionPolicy::Translated, OptCategory::OutputSelection, false,
          "write a .d dependency file next to the output while compiling (upstream 49da19a3d)"),
        e("-MQ", &["-MQ"], OptionPolicy::Translated, OptCategory::OutputSelection, true,
          "like -MT but Makefile-quote the targets (upstream 49da19a3d)"),
        e("-fcopybook-deps", &["-fcopybook-deps"], OptionPolicy::Translated, OptCategory::OutputSelection, false,
          "dependency lines list the copybook names only (upstream 49da19a3d)"),
        e("-MG", &["-MG"], OptionPolicy::RejectedUnsupported, OptCategory::OutputSelection, false,
          "keep-missing dependency listing: the candidate's COPY resolver reports unresolved names as a fail-closed error; tolerating them would silently weaken copybook resolution (typed boundary)"),
