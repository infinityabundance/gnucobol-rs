...
*Companion oracle harness for the **gnucobol-rs 0.7.65** release — this README is generated by `xtask docs`; freshness (content + version) is enforced by the `docs check` gate.*
