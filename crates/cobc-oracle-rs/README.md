...
*Companion oracle harness for the **gnucobol-rs 0.8.54** release — this README is generated by `xtask docs`; freshness (content + version) is enforced by the `docs check` gate.*
