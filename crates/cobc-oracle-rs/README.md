<!--
DO NOT EDIT BY HAND. Generated by xtask docs from docs-src/crate-cobc-oracle-rs-readme.model.json
...
*Companion oracle harness for the **gnucobol-rs 0.7.57** release — this README is generated by `xtask docs`; freshness (content + version) is enforced by the `docs check` gate.*
