...
*This README is generated by `xtask docs` for **gnucobol-rs 0.7.57** — regenerate with `cargo run -p xtask -- docs generate`; freshness (content + version) is enforced by the `docs check` gate.*
