...
| `GNURUST.VALUE.NEGZERO.EDGE.1` | negative-zero VALUE sign edge (oracle-characterized, locks the divergence) | ✅ pass | `reports/casefiles/GNURUST.VALUE.NEGZERO.EDGE.1/` |
