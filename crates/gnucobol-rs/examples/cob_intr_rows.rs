...
fn main() {
    ...
    hexln("ord_A", &cob_intr_ord(b"A", None));
    hexln(
        "char_66",
        &cob_intr_char(b"066", &disp(3, 0, false), None).0,
    );
    ...
    hexln(
        "iod",
        &cob_intr_integer_of_date(b"20240229", &disp(8, 0, false)),
    );
    hexln(
        "doi",
        &cob_intr_date_of_integer(b"00154794", &disp(8, 0, false)),
    );
    hexln(
        "ioday",
        &cob_intr_integer_of_day(b"2024060", &disp(7, 0, false)),
    );
    hexln(
        "doiy",
        &cob_intr_day_of_integer(b"00154794", &disp(8, 0, false)),
    );
    ...
    hexln(
        "concat",
        &cob_intr_concatenate(0, 0, &[b"AB", b"CD", b"EF"]),
    );
    let u3 = disp(3, 0, false);
    hexln(
        "sum",
        &cob_intr_sum(&[(b"010", &u3), (b"020", &u3), (b"030", &u3)]),
    );
    hexln(
        "max",
        &cob_intr_max(&[(b"010", &u3), (b"030", &u3), (b"020", &u3)]),
    );
    hexln(
        "min",
        &cob_intr_min(&[(b"010", &u3), (b"030", &u3), (b"020", &u3)]),
    );
    ...
    hexln(
        "median4",
        &cob_intr_median(&[(b"010", &u3), (b"020", &u3), (b"030", &u3), (b"040", &u3)]),
    );
    ...
    hexln(
        "frac0",
        &cob_intr_fraction_part(b"0123", &disp(4, 0, false)),
    );
    hexln(
        "tdate_ok",
        &cob_intr_test_date_yyyymmdd(b"20240229", &disp(8, 0, false)),
    );
    hexln(
        "tdate_bad",
        &cob_intr_test_date_yyyymmdd(b"20230229", &disp(8, 0, false)),
    );
    hexln(
        "tdate_mon",
        &cob_intr_test_date_yyyymmdd(b"20241301", &disp(8, 0, false)),
    );
    hexln(
        "tday_ok",
        &cob_intr_test_day_yyyyddd(b"2024060", &disp(7, 0, false)),
    );
    hexln(
        "tday_bad",
        &cob_intr_test_day_yyyyddd(b"2023366", &disp(7, 0, false)),
    );
    ...
    hexln(
        "subst",
        &cob_intr_substitute(0, 0, b"MISSISSIPPI", subst_pairs),
    );
    let subst_c_pairs: &[(&[u8], &[u8])] = &[(b"L", b"_")];
    hexln(
        "subst_c",
        &cob_intr_substitute_case(0, 0, b"Hello", subst_c_pairs),
    );
    ...
    hexln(
        "iofd_ymd",
        &cob_intr_integer_of_formatted_date(b"YYYYMMDD", b"20240229"),
    );
    hexln(
        "iofd_ymdh",
        &cob_intr_integer_of_formatted_date(b"YYYY-MM-DD", b"2024-02-29"),
    );
    hexln(
        "iofd_ddd",
        &cob_intr_integer_of_formatted_date(b"YYYYDDD", b"2024060"),
    );
    hexln(
        "iofd_www",
        &cob_intr_integer_of_formatted_date(b"YYYYWwwD", b"2024W092"),
    );
    hexln(
        "iofd_wwwh",
        &cob_intr_integer_of_formatted_date(b"YYYY-Www-D", b"2024-W09-2"),
    );
    hexln(
        "iofd_dt",
        &cob_intr_integer_of_formatted_date(b"YYYY-MM-DDThh:mm:ss", b"2024-02-29T12:00:00"),
    );
    hexln(
        "iofd_bad",
        &cob_intr_integer_of_formatted_date(b"YYYYMMDD", b"20240230"),
    );
    hexln(
        "iofd_badf",
        &cob_intr_integer_of_formatted_date(b"ZZZZ", b"x"),
    );
    hexln(
        "iofd_base",
        &cob_intr_integer_of_formatted_date(b"YYYYMMDD", b"16010101"),
    );
    let d7 = disp(7, 0, false);
    hexln(
        "fd_1ymd",
        &cob_intr_formatted_date(0, 0, b"YYYYMMDD", b"0000001", &d7),
    );
    hexln(
        "fd_1ymdh",
        &cob_intr_formatted_date(0, 0, b"YYYY-MM-DD", b"0000001", &d7),
    );
    hexln(
        "fd_1ddd",
        &cob_intr_formatted_date(0, 0, b"YYYYDDD", b"0000001", &d7),
    );
    hexln(
        "fd_1www",
        &cob_intr_formatted_date(0, 0, b"YYYYWwwD", b"0000001", &d7),
    );
    hexln(
        "fd_1wwwh",
        &cob_intr_formatted_date(0, 0, b"YYYY-Www-D", b"0000001", &d7),
    );
    hexln(
        "fd_mod",
        &cob_intr_formatted_date(0, 0, b"YYYY-MM-DD", b"0154789", &d7),
    );
    hexln(
        "fd_modw",
        &cob_intr_formatted_date(0, 0, b"YYYY-Www-D", b"0154789", &d7),
    );
    hexln(
        "fd_inv",
        &cob_intr_formatted_date(0, 0, b"YYYYMMDD", b"0000000", &d7),
    );
    hexln(
        "fd_badf",
        &cob_intr_formatted_date(0, 0, b"BAD", b"0000001", &d7),
    );
    hexln(
        "tfdt_d",
        &cob_intr_test_formatted_datetime(b"YYYYMMDD", b"20240229"),
    );
    hexln(
        "tfdt_t",
        &cob_intr_test_formatted_datetime(b"hhmmss", b"120000"),
    );
    hexln(
        "tfdt_tdec",
        &cob_intr_test_formatted_datetime(b"hh:mm:ss.ss", b"12:00:00.50"),
    );
    hexln(
        "tfdt_dt",
        &cob_intr_test_formatted_datetime(b"YYYY-MM-DDThh:mm:ss", b"2024-02-29T12:00:00"),
    );
    hexln(
        "tfdt_bh",
        &cob_intr_test_formatted_datetime(b"hhmmss", b"250000"),
    );
    hexln(
        "tfdt_z",
        &cob_intr_test_formatted_datetime(b"hhmmssZ", b"120000Z"),
    );
    hexln(
        "tfdt_off",
        &cob_intr_test_formatted_datetime(b"hh:mm:ss+hh:mm", b"12:00:00+05:30"),
    );
    hexln(
        "tfdt_not",
        &cob_intr_test_formatted_datetime(b"YYYY-MM-DDThh:mm:ss", b"2024-02-29X12:00:00"),
    );
    hexln(
        "tfdt_bs",
        &cob_intr_test_formatted_datetime(b"hhmmss", b"120061"),
    );
    hexln(
        "tfdt_bad",
        &cob_intr_test_formatted_datetime(b"GARBAGE", b"x"),
    );
    ...
    hexln(
        "sfft_noon",
        &cob_intr_seconds_from_formatted_time(b"hhmmss", b"120000"),
    );
    hexln(
        "sfft_dec",
        &cob_intr_seconds_from_formatted_time(b"hh:mm:ss.ss", b"12:00:00.50"),
    );
    hexln(
        "sfft_123",
        &cob_intr_seconds_from_formatted_time(b"hh:mm:ss", b"01:02:03"),
    );
    hexln(
        "sfft_eod",
        &cob_intr_seconds_from_formatted_time(b"hhmmss.sss", b"235959.125"),
    );
    hexln(
        "sfft_dt",
        &cob_intr_seconds_from_formatted_time(b"YYYY-MM-DDThh:mm:ss", b"2024-02-29T06:30:00"),
    );
    hexln(
        "sfft_bad",
        &cob_intr_seconds_from_formatted_time(b"hhmmss", b"250000"),
    );
    ...
    hexln(
        "ft_plain",
        &cob_intr_formatted_time(0, 0, b"hhmmss", b"0043200", &d7n, None, false),
    );
    hexln(
        "ft_colon",
        &cob_intr_formatted_time(0, 0, b"hh:mm:ss", b"0043200", &d7n, None, false),
    );
    hexln(
        "ft_frac",
    ...
    hexln(
        ...
        &cob_intr_formatted_time(
            ...
            b"0043200",
            &d7n,
            Some((b"\x88\xff\xff\xff", &binneg)),
            false,
        ),
    );
    hexln(
        "ft_inv",
        &cob_intr_formatted_time(0, 0, b"hhmmss", b"0090000", &d7n, None, false),
    );
    hexln(
        "fdt_plain",
    ...
    hexln("nvf2_sci", &cob_intr_numval_f(b"1.5E+10", b'.'));
    hexln("nvf2_neg", &cob_intr_numval_f(b"-12.34", b'.'));
    hexln("nvf2_em3", &cob_intr_numval_f(b"1E-3", b'.'));
    hexln("nvf2_lead", &cob_intr_numval_f(b"000123.450", b'.'));
    hexln("nvf2_e2", &cob_intr_numval_f(b"-7.5e2", b'.'));
    hexln("nvf2_zero", &cob_intr_numval_f(b"0", b'.'));
    // DECIMAL-POINT IS COMMA: the separator is ',' (the oracle sets module decimal_point=',').
    hexln("nvf2_comma", &cob_intr_numval_f(b"1,5", b','));
    hexln("nvf2_comma_e", &cob_intr_numval_f(b"-12,34E+2", b','));
    ...
    hexln(
        "bo_powh",
        &cob_intr_binop(b"009", &u3, b'^', b"5", &disp(1, 1, false)),
    );
    ...
    hexln(
        "annu",
        &cob_intr_annuity(b"005", &disp(3, 2, false), b"10", &disp(2, 0, false)),
    );
    hexln(
        "annu0",
        &cob_intr_annuity(b"000", &u3, b"05", &disp(2, 0, false)),
    );
    hexln(
        "pv",
        &cob_intr_present_value(b"010", &disp(3, 2, false), &[(b"100", &u3), (b"200", &u3)]),
    );
    hexln(
        "var",
        &cob_intr_variance(&[(b"002", &u3), (b"004", &u3), (b"006", &u3)]),
    );
    hexln(
        "sdev",
        &cob_intr_standard_deviation(&[(b"002", &u3), (b"004", &u3), (b"006", &u3)]),
    );
    hexln(
        "whenc",
        &cob_intr_when_compiled(0, 0, b"2024010112000000-0500", &an),
    );
    hexln(
        "whenc_rm",
        &cob_intr_when_compiled(3, 4, b"2024010112000000-0500", &an),
    );
    hexln("cdate", &cob_intr_current_date(0, 0));
    hexln(
        "fcd",
        &cob_intr_formatted_current_date(0, 0, b"YYYY-MM-DDThh:mm:ss"),
    );
    hexln(
        "fcd2",
        &cob_intr_formatted_current_date(0, 0, b"YYYYMMDDThhmmss"),
    );
    hexln("mid", &cob_intr_module_id(b"MYMOD"));
    hexln("msrc", &cob_intr_module_source(b"mymod.cob"));
    hexln(
        "mfd",
        &cob_intr_module_formatted_date(b"2024/02/29 12:34:56"),
    );
    ...
    hexln(
        "locdate",
        &cob_intr_locale_date(0, 0, b"20240229", &disp(8, 0, false), None),
    );
    hexln(
        "loctime",
        &cob_intr_locale_time(0, 0, b"123456", &disp(6, 0, false), None),
    );
    hexln(
        "lcltfs",
        &cob_intr_lcl_time_from_secs(0, 0, b"43200", &disp(5, 0, false), None),
    );
    ...
    hexln(
        "clen_null",
        &cob_intr_content_length(b"\x00\x00\x00\x00\x00\x00\x00\x00"),
    );
    hexln(
        "cof_null",
        &cob_intr_content_of(0, 0, b"\x00\x00\x00\x00\x00\x00\x00\x00", 1),
    );
