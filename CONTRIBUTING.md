<!--
DO NOT EDIT BY HAND. Generated by lab/docs/generate.py from docs-src/contributing.model.json
...
Evidence authority: the claim-ladder + generated casefiles. Legacy source preserved (lossless) under research/legacyreports/CONTRIBUTING.md (sha256 96af44147feaaa273387a6addea43c05cde6b83ec1f370af5f77be7da70ea00c).
-->

# Contributing to gnucobol-rs

> _Generated document (TRUST.4.DOCS). Machine authority: `reports/claim-ladder.json` + `reports/casefiles/`. Legacy source preserved losslessly under `research/legacyreports/CONTRIBUTING.md`._
