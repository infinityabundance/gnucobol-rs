<!--
DO NOT EDIT BY HAND. Generated by lab/docs/generate.py from docs-src/audits-readme.model.json
...
|-------|-------|------------------|
| oracle sweeps (56 GNURUST courts) | **green** | `bash lab/verify-sealed-courts.sh` (needs built oracle) |
