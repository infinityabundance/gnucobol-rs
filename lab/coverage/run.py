...
SURFACES = [
 ...
 ("intrinsics", "intrinsics", ["libcob/intrinsic.c"], "observed", ["GNURUST.INTRINSIC.ATLAS.1"], None,
   "NUMVAL/LENGTH/MOD/CURRENT-DATE etc. hide many migration errors; observed atlas before per-intrinsic courts"),
