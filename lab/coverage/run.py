...
SURFACES = [
 ...
 ("intrinsics", "intrinsics", ["libcob/intrinsic.c"], "observed", ["GNURUST.INTRINSIC.ATLAS.1", "GNURUST.INTRINSIC.LENGTH.1", "GNURUST.INTRINSIC.NUMVAL.1", "GNURUST.INTRINSIC.MOD-REM.1", "GNURUST.INTRINSIC.INTEGER.1", "GNURUST.INTRINSIC.CASE.1", "GNURUST.INTRINSIC.ORD-CHAR.1"], None,
