...
SURFACES = [
 ...
 ("procedure-flow", "control flow", ["cobc/typeck.c","cobc/codegen.c"], "observed", ["GNURUST.PROCEDURE.FLOW.ATLAS.1", "GNURUST.IF.EVALUATE.SLICE.1", "GNURUST.PERFORM.SLICE.1"], None,
