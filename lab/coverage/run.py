...
SURFACES = [
 ...
 ("file-io-sequential", "file I/O", ["libcob/fileio.c"], "missing", [], "GNURUST.FILE.SEQUENTIAL.1",
   "sequential/line READ record bytes + AT END drive most batch COBOL logic; unported = no file pipeline"),
 ("file-status", "file I/O", ["libcob/fileio.c"], "missing", [], "GNURUST.FILE.STATUS.1",
   "real COBOL branches on file-status codes (00/10/35/...); unported = wrong control flow"),
