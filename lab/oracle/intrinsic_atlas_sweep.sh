...
atlas = {
 ...
 "intrinsics":[
  ...
  {"name":"UPPER-CASE","category":"string","input":"\"abc\"","observed":"ABC","determinism":"deterministic","status":"implemented","note":"GNURUST.INTRINSIC.CASE.1 -- ASCII fold"},
  {"name":"LOWER-CASE","category":"string","input":"\"ABC\"","observed":"abc","determinism":"deterministic","status":"implemented","note":"GNURUST.INTRINSIC.CASE.1 -- ASCII fold"},
  {"name":"REVERSE","category":"string","input":"\"abcd\"","observed":"dcba","determinism":"deterministic","status":"implemented","note":"GNURUST.INTRINSIC.CASE.1 -- byte reversal"},
  {"name":"ORD","category":"char","input":"\"A\"","observed":"66","determinism":"deterministic","status":"implemented","note":"1-based position in the collating sequence (ASCII 'A'=65 -> 66)"},
  {"name":"CHAR","category":"char","input":"66","observed":"A","determinism":"deterministic","status":"implemented","note":"1-based inverse of ORD"},
