...
atlas = {
 ...
 "intrinsics":[
  ...
  {"name":"MOD","category":"modulo","input":"17,5 / -17,5","observed":"2 / 3","determinism":"deterministic","status":"candidate-court","note":"result takes the DIVISOR sign (mathematical modulo)"},
  {"name":"REM","category":"modulo","input":"17,5 / -17,5","observed":"2 / -2","determinism":"deterministic","status":"candidate-court","note":"result takes the DIVIDEND sign (C-style remainder)"},
