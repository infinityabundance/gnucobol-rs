<!--
DO NOT EDIT BY HAND. Generated by lab/docs/generate.py from docs-src/reports-gnucobol_cobol_atlas_state_of_industry.model.json
...
58 GNURUST courts (see `reports/claim-ladder.json`): decimal MOVE, PIC/field-model (+P), layout (+ODO
