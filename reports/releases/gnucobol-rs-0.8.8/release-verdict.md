# Release verdict — gnucobol-rs 0.8.8

_Generated 2026-06-19T01:10:19Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.8 (gnurust) |
| git commit | `5002b22396dd213cb389f9e81a36941b19ffdce4` |
| dependencies | 31 |
