# Release verdict — gnucobol-rs 0.8.50

_Generated 2026-06-23T21:14:18Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.50 (gnurust) |
| git commit | `11352031412f639f491b8461fdb425169b0dee55` |
| dependencies | 31 |
