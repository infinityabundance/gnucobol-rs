# Release verdict — gnucobol-rs-ffi 0.1.0

_Generated 2026-06-19T01:25:36Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs-ffi` 0.1.0 (gnurust) |
| git commit | `0b523e1ad998a2215eab6e7c76890d2e556ff0ed` |
| dependencies | 31 |
| sealed courts in this crate | 101 |
| TRUST.2 receipts | 95 |
