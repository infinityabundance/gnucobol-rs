# Release verdict — gnucobol-rs-corpus 0.1.4

_Generated 2026-08-13T01:37:38Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs-corpus` 0.1.4 (gnurust) |
| git commit | `717db8811a03ac2bec45bb110748013c68864fc3` |
| dependencies | 47 |
| sealed courts in this crate | 140 |
| TRUST.2 receipts | 130 |
