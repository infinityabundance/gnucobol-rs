# Release verdict — gnucobol-rs 0.7.4

_Generated 2026-06-09T01:55:44Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.4 (gnurust) |
| git commit | `d63985fc3ad20c97ebca05f3f735f117425e4cea` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 23 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 19 (`receipt-manifest.json`) |
