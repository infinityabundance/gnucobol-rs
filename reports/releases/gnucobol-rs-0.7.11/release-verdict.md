# Release verdict — gnucobol-rs 0.7.11

_Generated 2026-06-09T05:12:09Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.11 (gnurust) |
| git commit | `898932de5bae3461292c184ab38f08fad55d416b` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 32 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 28 (`receipt-manifest.json`) |
