# Release verdict — gnucobol-rs 0.7.85

_Generated 2026-06-16T09:42:19Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.85 (gnurust) |
| git commit | `fc3d1cefcd7bcfb9672e1f2efece965b3710bcb9` |
| dependencies | 29 |
