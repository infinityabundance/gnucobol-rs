# Release verdict — gnucobol-rs 0.7.5

_Generated 2026-06-09T02:21:51Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.5 (gnurust) |
| git commit | `61ac904524d2eb239721eae04e8b62f16bdb763a` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 24 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 20 (`receipt-manifest.json`) |
