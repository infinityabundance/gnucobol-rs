# Release verdict — gnucobol-rs 0.7.2

_Generated 2026-06-08T14:42:09Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.2 (gnurust) |
| git commit | `0eadce073fe4c742c6bc571e0b9b1c6f580c77c3` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 19 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 16 (`receipt-manifest.json`) |
