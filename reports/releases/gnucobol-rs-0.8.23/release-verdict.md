# Release verdict — gnucobol-rs 0.8.23

_Generated 2026-06-21T02:20:34Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.23 (gnurust) |
| git commit | `0cbaa0aef138a5ce2fb49171dac70e3b8ff0bacd` |
| dependencies | 31 |
