# Release verdict — gnucobol-rs-corpus 0.1.5

_Generated 2026-08-13T03:58:38Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs-corpus` 0.1.5 (gnurust) |
| git commit | `403cbd13da397c6a88a42cda4c62c884562109ca` |
| dependencies | 47 |
