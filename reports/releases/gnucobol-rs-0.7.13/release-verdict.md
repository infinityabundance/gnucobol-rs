# Release verdict — gnucobol-rs 0.7.13

_Generated 2026-06-09T05:34:07Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.13 (gnurust) |
| git commit | `25647dc40c3d0c733c5f24583297d8a1259c133e` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 34 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 30 (`receipt-manifest.json`) |
