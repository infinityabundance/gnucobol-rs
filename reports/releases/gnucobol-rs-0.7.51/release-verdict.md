# Release verdict — gnucobol-rs 0.7.51

_Generated 2026-06-14T08:30:25Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.51 (gnurust) |
| git commit | `8381e1cebb2ef9993472d0ff552be5fabf1423bc` |
| dependencies | 29 |
| sealed courts in this crate | 83 |
| TRUST.2 receipts | 77 |
