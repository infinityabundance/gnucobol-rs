# Release verdict — gnucobol-rs 0.8.34

_Generated 2026-06-21T22:27:43Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.34 (gnurust) |
| git commit | `c2506a1dd2b7f4e88947e9b07c22c8148aeeb9ad` |
| dependencies | 31 |
