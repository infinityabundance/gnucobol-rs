# Release verdict — gnucobol-rs 0.8.22

_Generated 2026-06-21T02:10:02Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.22 (gnurust) |
| git commit | `94f247a89b4b09d276b0dce12ad6ae2b04cabf02` |
| dependencies | 31 |
