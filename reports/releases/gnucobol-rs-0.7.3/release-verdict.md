# Release verdict — gnucobol-rs 0.7.3

_Generated 2026-06-09T01:10:51Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.3 (gnurust) |
| git commit | `536964f7d5c2bc0a0b842dade67cd1246343132b` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 21 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 17 (`receipt-manifest.json`) |
