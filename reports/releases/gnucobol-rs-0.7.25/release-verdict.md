# Release verdict — gnucobol-rs 0.7.25

_Generated 2026-06-09T10:52:07Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.25 (gnurust) |
| git commit | `c31e653e797f7ff1f90e25c00698e34cfad2ff58` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 46 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 42 (`receipt-manifest.json`) |
