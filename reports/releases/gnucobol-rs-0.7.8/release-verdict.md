# Release verdict — gnucobol-rs 0.7.8

_Generated 2026-06-09T04:13:29Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.8 (gnurust) |
| git commit | `adaa0076b2f9190964c9ecc18831caee7a4f91a8` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 28 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 24 (`receipt-manifest.json`) |
