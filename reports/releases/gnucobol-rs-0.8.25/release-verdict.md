# Release verdict — gnucobol-rs 0.8.25

_Generated 2026-06-21T18:01:28Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.25 (gnurust) |
| git commit | `76bd0e70b534f4102d55777aa8bf5958c0517533` |
| dependencies | 31 |
