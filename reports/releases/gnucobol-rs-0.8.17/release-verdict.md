# Release verdict — gnucobol-rs 0.8.17

_Generated 2026-06-20T21:13:51Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.17 (gnurust) |
| git commit | `8357cb8493cb1de0d696a5d2bf807050b7e4c04c` |
| dependencies | 31 |
