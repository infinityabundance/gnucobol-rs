# Release verdict — gnucobol-rs 0.7.1

_Generated 2026-06-08T01:49:23Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.1 (gnurust) |
| git commit | `4ee991a725d1f68bf8114b8f1fd7b5cbf5129141` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 18 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 15 (`receipt-manifest.json`) |
