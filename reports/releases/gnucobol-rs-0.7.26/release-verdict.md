# Release verdict — gnucobol-rs 0.7.26

_Generated 2026-06-09T12:36:29Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.26 (gnurust) |
| git commit | `8c85f6aaf24df79da045e983ed2c46af7567fe8d` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 52 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 46 (`receipt-manifest.json`) |
