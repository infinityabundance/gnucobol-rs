# Release verdict — gnucobol-rs 0.8.56

_Generated 2026-08-11T01:54:14Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.56 (gnurust) |
