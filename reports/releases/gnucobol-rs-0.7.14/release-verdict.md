# Release verdict — gnucobol-rs 0.7.14

_Generated 2026-06-09T05:42:49Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.14 (gnurust) |
| git commit | `814ac71c129951f83ae7a80dedcc2884c27623af` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 35 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 31 (`receipt-manifest.json`) |
