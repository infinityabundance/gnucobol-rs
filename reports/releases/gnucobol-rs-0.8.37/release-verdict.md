# Release verdict — gnucobol-rs 0.8.37

_Generated 2026-06-22T01:54:40Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.37 (gnurust) |
| git commit | `6e8fd9d99fd1354e1852105413de7d26caada0d3` |
| dependencies | 31 |
