# Release verdict — gnucobol-rs 0.8.40

_Generated 2026-06-22T03:19:56Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.40 (gnurust) |
| git commit | `6898bed687eee83f1fcaf0164dc14c7c3f3373cb` |
| dependencies | 31 |
