# Release verdict — gnucobol-rs 0.8.18

_Generated 2026-06-20T22:11:44Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.18 (gnurust) |
| git commit | `ff6054719b52c496fab8cf079ab18b453eaaec3c` |
| dependencies | 31 |
