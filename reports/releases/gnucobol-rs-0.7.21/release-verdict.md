# Release verdict — gnucobol-rs 0.7.21

_Generated 2026-06-09T09:44:23Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.21 (gnurust) |
| git commit | `9d98e277475e8db157e3354862d199a9a8040565` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 42 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 38 (`receipt-manifest.json`) |
