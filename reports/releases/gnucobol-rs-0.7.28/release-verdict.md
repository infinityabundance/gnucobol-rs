# Release verdict — gnucobol-rs 0.7.28

_Generated 2026-06-11T08:06:42Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.28 (gnurust) |
| git commit | `d00c42877ed7b699b3d3ee0db5c873459f2992d7` |
| dependencies | 28 |
| sealed courts in this crate | 63 |
| TRUST.2 receipts | 57 |
