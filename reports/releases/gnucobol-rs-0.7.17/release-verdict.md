# Release verdict — gnucobol-rs 0.7.17

_Generated 2026-06-09T07:17:59Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.17 (gnurust) |
| git commit | `2f7f8102e7cb229076ca83b47ac66b588e9f5a5c` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 38 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 34 (`receipt-manifest.json`) |
