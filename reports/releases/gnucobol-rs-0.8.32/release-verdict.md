# Release verdict — gnucobol-rs 0.8.32

_Generated 2026-06-21T21:35:32Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.32 (gnurust) |
| git commit | `a23098e9eb98d2b80752394ff6c2ac0e05297364` |
| dependencies | 31 |
