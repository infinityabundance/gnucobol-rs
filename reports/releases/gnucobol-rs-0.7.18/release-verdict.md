# Release verdict — gnucobol-rs 0.7.18

_Generated 2026-06-09T09:06:59Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.18 (gnurust) |
| git commit | `411422d8edb5046ab39b6b5fcb76dc50b529ac33` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 39 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 35 (`receipt-manifest.json`) |
