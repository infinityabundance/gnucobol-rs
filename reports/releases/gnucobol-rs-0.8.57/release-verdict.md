# Release verdict — gnucobol-rs 0.8.57

_Generated 2026-08-12T02:36:26Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.57 (gnurust) |
