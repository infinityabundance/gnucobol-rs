# Release verdict — gnucobol-rs 0.7.27

_Generated 2026-06-10T10:43:22Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.27 (gnurust) |
| git commit | `ae2f2a8cab7732978daf1abf26ad283adfeaa5e1` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 62 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 56 (`receipt-manifest.json`) |
