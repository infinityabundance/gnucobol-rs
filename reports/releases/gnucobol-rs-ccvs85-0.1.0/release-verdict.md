# Release verdict — gnucobol-rs-ccvs85 0.1.0

_Generated 2026-08-04T17:51:24Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs-ccvs85` 0.1.0 (gnurust) |
