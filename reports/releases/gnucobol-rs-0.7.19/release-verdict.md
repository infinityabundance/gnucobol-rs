# Release verdict — gnucobol-rs 0.7.19

_Generated 2026-06-09T09:19:28Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.19 (gnurust) |
| git commit | `5604afbad456a98a6bb7ece5e52fcab826bb27c9` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 40 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 36 (`receipt-manifest.json`) |
