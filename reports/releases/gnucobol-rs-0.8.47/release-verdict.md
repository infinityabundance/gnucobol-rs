# Release verdict — gnucobol-rs 0.8.47

_Generated 2026-06-23T03:11:09Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.47 (gnurust) |
| git commit | `0d97d4a7f3e5ca0838d7def77ecc3aaf6e168a2f` |
| dependencies | 31 |
