# Release verdict — gnucobol-rs 0.8.36

_Generated 2026-06-21T23:40:31Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.36 (gnurust) |
| git commit | `f12b9f09dde14626c78b43fb81c88749853464c5` |
| dependencies | 31 |
