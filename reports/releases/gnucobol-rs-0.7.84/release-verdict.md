# Release verdict — gnucobol-rs 0.7.84

_Generated 2026-06-16T09:20:35Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.84 (gnurust) |
| git commit | `b817d7011db846f1a1e4cf36386e109ce84df3a0` |
| dependencies | 29 |
