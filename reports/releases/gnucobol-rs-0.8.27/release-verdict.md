# Release verdict — gnucobol-rs 0.8.27

_Generated 2026-06-21T19:14:23Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.27 (gnurust) |
| git commit | `79da7664b72a0fa22b960ecc8b63e38c9cb1d1d8` |
| dependencies | 31 |
