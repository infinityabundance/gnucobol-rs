# Release verdict — gnucobol-rs 0.8.45

_Generated 2026-06-22T14:16:14Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.45 (gnurust) |
| git commit | `318f403f25bde74efc7bf7aea8d5cc9be7be3ced` |
| dependencies | 31 |
