# Release verdict — gnucobol-rs-testsuite 0.1.1

_Generated 2026-08-12T03:51:12Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs-testsuite` 0.1.1 (gnurust) |
