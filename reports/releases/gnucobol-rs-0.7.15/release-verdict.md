# Release verdict — gnucobol-rs 0.7.15

_Generated 2026-06-09T06:00:55Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.15 (gnurust) |
| git commit | `c8153642a24af0f0dc289826873fcf129eb5888b` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 36 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 32 (`receipt-manifest.json`) |
