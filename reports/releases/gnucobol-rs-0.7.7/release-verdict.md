# Release verdict — gnucobol-rs 0.7.7

_Generated 2026-06-09T03:59:08Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.7 (gnurust) |
| git commit | `d8380d24e975948d7e11a824ce768d940815cbd4` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 27 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 23 (`receipt-manifest.json`) |
