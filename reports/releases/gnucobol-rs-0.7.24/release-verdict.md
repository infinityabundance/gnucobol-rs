# Release verdict — gnucobol-rs 0.7.24

_Generated 2026-06-09T10:38:03Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.24 (gnurust) |
| git commit | `7138f8276272df0e13d713ac043d627104086998` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 45 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 41 (`receipt-manifest.json`) |
