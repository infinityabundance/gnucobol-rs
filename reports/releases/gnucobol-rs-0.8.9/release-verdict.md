# Release verdict — gnucobol-rs 0.8.9

_Generated 2026-06-20T14:43:57Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.9 (gnurust) |
| git commit | `089627347501bbab776ea2b8a61d29a34292296b` |
| dependencies | 31 |
