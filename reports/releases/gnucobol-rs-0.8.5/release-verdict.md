# Release verdict — gnucobol-rs 0.8.5

_Generated 2026-06-17T23:12:08Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.5 (gnurust) |
| git commit | `0d578b7c85a9e48811536e2f6b354081ec726f49` |
| dependencies | 30 |
