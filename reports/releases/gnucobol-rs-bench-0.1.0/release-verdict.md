# Release verdict — gnucobol-rs-bench 0.1.0

_Generated 2026-08-11T01:39:07Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs-bench` 0.1.0 (gnurust) |
