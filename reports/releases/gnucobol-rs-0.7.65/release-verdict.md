# Release verdict — gnucobol-rs 0.7.65

_Generated 2026-06-14T19:04:05Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.65 (gnurust) |
| git commit | `77cbd184c9cc054c97e2f9190decf7677ca8d467` |
| dependencies | 29 |
| sealed courts in this crate | 89 |
| TRUST.2 receipts | 83 |
