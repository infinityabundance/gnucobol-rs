# Release verdict — gnucobol-rs 0.7.20

_Generated 2026-06-09T09:34:57Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.20 (gnurust) |
| git commit | `fd6757d882c10472f26941b698002076a3ec90ad` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 41 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 37 (`receipt-manifest.json`) |
