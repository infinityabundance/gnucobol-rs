# Release verdict — gnucobol-rs 0.7.75

_Generated 2026-06-15T12:23:26Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.75 (gnurust) |
| git commit | `0ed9363347519baf429f73598c4306d1c9ab806e` |
| dependencies | 29 |
| sealed courts in this crate | 95 |
| TRUST.2 receipts | 89 |
