# Release verdict — gnucobol-rs 0.7.23

_Generated 2026-06-09T10:24:31Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.23 (gnurust) |
| git commit | `8cbfd4a3e4c42f1491d3119cdcdf7a20b305ac07` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 44 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 40 (`receipt-manifest.json`) |
