# Release verdict — gnucobol-rs 0.7.6

_Generated 2026-06-09T02:45:05Z from the machine files in this packet. A release is an evidence packet, not merely a
version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.6 (gnurust) |
| git commit | `7b21184e4fc4c2187c1dfe04ae6f2ade564a6ec7` |
| publish status | pending_crates_io_rate_limit_window |
| this-crate license | LGPL-3.0-or-later |
| dependencies | 2 (SBOM: `sbom.spdx.json`) |
| sealed courts in this crate | 25 (`claim-ladder-snapshot.json`) |
| TRUST.2 receipts | 21 (`receipt-manifest.json`) |
