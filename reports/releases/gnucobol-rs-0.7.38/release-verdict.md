# Release verdict — gnucobol-rs 0.7.38

_Generated 2026-06-12T04:48:59Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.38 (gnurust) |
| git commit | `06756a644a8952157e4f6322c20a0f3da4f80c2c` |
| dependencies | 28 |
| sealed courts in this crate | 74 |
| TRUST.2 receipts | 68 |
