# Release verdict — gnucobol-rs 0.7.74

_Generated 2026-06-15T11:45:32Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.74 (gnurust) |
| git commit | `2e877d1e6802382d63a1b919281e320cbc966900` |
| dependencies | 29 |
