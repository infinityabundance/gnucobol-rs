# Release verdict — gnucobol-rs 0.7.83

_Generated 2026-06-16T09:04:23Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.83 (gnurust) |
| git commit | `9357a7cacbcce8bd295e772450e4591ac653fd0e` |
| dependencies | 29 |
