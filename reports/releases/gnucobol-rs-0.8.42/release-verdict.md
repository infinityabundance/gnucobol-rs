# Release verdict — gnucobol-rs 0.8.42

_Generated 2026-06-22T12:31:23Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.42 (gnurust) |
| git commit | `0cd901da5aec41469b9f905b13c08c4d64e214bf` |
| dependencies | 31 |
