# Release verdict — gnucobol-rs 0.7.39

_Generated 2026-06-12T06:12:40Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.7.39 (gnurust) |
| git commit | `02b642b0d3424162545651fad9abc394491c4256` |
| dependencies | 28 |
| sealed courts in this crate | 75 |
| TRUST.2 receipts | 69 |
