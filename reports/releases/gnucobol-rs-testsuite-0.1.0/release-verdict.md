# Release verdict — gnucobol-rs-testsuite 0.1.0

_Generated 2026-08-04T17:51:42Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs-testsuite` 0.1.0 (gnurust) |
| git commit | `5c2057cfc15541371c2c2193d3705012215d9a27` |
| dependencies | 45 |
| sealed courts in this crate | 124 |
| TRUST.2 receipts | 114 |
