# Release verdict — gnucobol-rs 0.8.31

_Generated 2026-06-21T21:17:43Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.31 (gnurust) |
| git commit | `e0cdbe42588d37ff90ba98db62a4a1794392c5e7` |
| dependencies | 31 |
