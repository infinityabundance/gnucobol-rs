# Release verdict — gnucobol-rs 0.8.20

_Generated 2026-06-21T00:25:23Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs` 0.8.20 (gnurust) |
| git commit | `a4759f297f3fd9cff12e07fb86c22252f98377c5` |
| dependencies | 31 |
