...
_Generated 2026-08-11T01:38:59Z from the machine files in this packet. A release is an evidence packet, not merely a version number._

| evidence | value |
|----------|-------|
| crate / version | `gnucobol-rs-corpus` 0.1.0 (gnurust) |
| git commit | `f098bf5b021e9a51c1473a098e84c82e64762960` |
| dependencies | 47 |
