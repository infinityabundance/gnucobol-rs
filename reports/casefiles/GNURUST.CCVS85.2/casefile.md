...
**Verdict: PASS** · lab/corpus/ccvs85/newcob.val.Z (committed, hash-pinned) + lab/docker/ccvs85 + lab/ccvs85/run-docker.sh (one-command replay) · crate `gnucobol-rs` 0.8.53
