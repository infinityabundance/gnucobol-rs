...
**Verdict: PASS** · crates/cobc-rs/tests/module_courts.rs (cobcrun_m_searches_the_module_directory, cobcrun_module_search_uses_cwd_and_library_path, cobcrun_error_messages_match_cobcrun) · crate `gnucobol-rs` 0.8.57
