...
**Verdict: PASS** · reports/gnucobol-testsuite/boundary-reduction-baseline.json + boundary-reduction.{json,md} + classification-transitions.{json,md} · crate `gnucobol-rs` 0.8.54
