...
# GNURUST.VALID-PROGRAMS.CCVS85.1 — valid-program corpus -- every CCVS85 unit is classified and the 512 units reconcile (programs.json)

**Verdict: PASS** · replay `PASS=1 FAIL=0 valid-ccvs85`
...
## Non-claims
- no NIST certification; no COBOL-85 conformance claim
