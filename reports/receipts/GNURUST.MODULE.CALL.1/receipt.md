...
# GNURUST.MODULE.CALL.1 — CALL semantics across separately compiled modules (sibling resolution + EXTERNAL sharing)

**Verdict: ORACLE-NOT-BUILT** · replay `oracle-not-built`

| field | value |
|-------|-------|
| campaign | `GNURUST.MODULE.CALL.1` |
| court | CALL semantics across separately compiled modules (sibling resolution + EXTERNAL sharing) |
