...
# GNURUST.PERFORMANCE.PREPARED.1 — performance corpus -- prepared-program execution (View C: already-compiled native binary vs already-prepared program, no candidate reparsing) with raw samples preserved
