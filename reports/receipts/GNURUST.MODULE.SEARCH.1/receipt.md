...
# GNURUST.MODULE.SEARCH.1 — cobcrun module search paths (-M dir, cwd, COB_LIBRARY_PATH) + error messages

**Verdict: ORACLE-NOT-BUILT** · replay `oracle-not-built`

| field | value |
|-------|-------|
| campaign | `GNURUST.MODULE.SEARCH.1` |
| court | cobcrun module search paths (-M dir, cwd, COB_LIBRARY_PATH) + error messages |
