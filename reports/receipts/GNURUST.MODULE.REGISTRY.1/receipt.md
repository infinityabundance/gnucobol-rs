...
# GNURUST.MODULE.REGISTRY.1 — interpreted module lifecycle -- cobcrun-rs runner + build-local module search (-M/cwd/COB_LIBRARY_PATH) + truthful -m artifacts

**Verdict: ORACLE-NOT-BUILT** · replay `oracle-not-built`

| field | value |
|-------|-------|
| campaign | `GNURUST.MODULE.REGISTRY.1` |
| court | interpreted module lifecycle -- cobcrun-rs runner + build-local module search (-M/cwd/COB_LIBRARY_PATH) + truthful -m artifacts |
