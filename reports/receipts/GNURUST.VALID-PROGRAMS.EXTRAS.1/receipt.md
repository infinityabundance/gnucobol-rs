...
# GNURUST.VALID-PROGRAMS.EXTRAS.1 — valid-program corpus -- GnuCOBOL-shipped programs and official contributions are inventoried (extras programs.json)

**Verdict: PASS** · replay `PASS=1 FAIL=0 valid-extras`
