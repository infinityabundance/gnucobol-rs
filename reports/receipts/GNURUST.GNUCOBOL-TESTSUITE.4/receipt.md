...
# GNURUST.GNUCOBOL-TESTSUITE.4 — GnuCOBOL-testsuite rerun after the three-boundary reduction (module lifecycle + parser/check waves + wrapper policy) -- re-measured ledger

**Verdict: ORACLE-NOT-BUILT** · replay `oracle-not-built`

| field | value |
|-------|-------|
| campaign | `GNURUST.GNUCOBOL-TESTSUITE.4` |
| court | GnuCOBOL-testsuite rerun after the three-boundary reduction (module lifecycle + parser/check waves + wrapper policy) -- re-measured ledger |
