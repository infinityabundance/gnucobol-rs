...
# GNURUST.GNUCOBOL-TESTSUITE.BOUNDARY-REDUCTION.1 — three-boundary reduction ledger (module 407 / parser-check 439 / wrapper-option 173) -- before/after per test

**Verdict: ORACLE-NOT-BUILT** · replay `oracle-not-built`

| field | value |
|-------|-------|
| campaign | `GNURUST.GNUCOBOL-TESTSUITE.BOUNDARY-REDUCTION.1` |
| court | three-boundary reduction ledger (module 407 / parser-check 439 / wrapper-option 173) -- before/after per test |
