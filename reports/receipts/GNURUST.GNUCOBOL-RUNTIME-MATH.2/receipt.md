...
# GNURUST.GNUCOBOL-RUNTIME-MATH.2 — runtime/mathematics campaign after the boundary-reduction work (math subset re-measured from the same full ledger)

**Verdict: ORACLE-NOT-BUILT** · replay `oracle-not-built`

| field | value |
|-------|-------|
| campaign | `GNURUST.GNUCOBOL-RUNTIME-MATH.2` |
| court | runtime/mathematics campaign after the boundary-reduction work (math subset re-measured from the same full ledger) |
