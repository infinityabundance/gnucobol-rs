...
# GNURUST.MODULE.PARALLEL.1 — module lifecycle under parallel execution (same basenames in isolated directories)

**Verdict: ORACLE-NOT-BUILT** · replay `oracle-not-built`

| field | value |
|-------|-------|
| campaign | `GNURUST.MODULE.PARALLEL.1` |
| court | module lifecycle under parallel execution (same basenames in isolated directories) |
