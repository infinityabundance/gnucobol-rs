...
# GNURUST.MODULE.CANCEL.1 — CANCEL semantics (persisted WORKING-STORAGE reset; active-program fatal)

**Verdict: ORACLE-NOT-BUILT** · replay `oracle-not-built`

| field | value |
|-------|-------|
| campaign | `GNURUST.MODULE.CANCEL.1` |
| court | CANCEL semantics (persisted WORKING-STORAGE reset; active-program fatal) |
