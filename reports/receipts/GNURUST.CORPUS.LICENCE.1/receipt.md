...
# GNURUST.CORPUS.LICENCE.1 — valid-COBOL corpus licence decisions -- licences.json records a decision for every family; unknown-licence source is quarantined, never published

**Verdict: PASS** · replay `PASS=1 FAIL=0 licence`
...
## Non-claims
- no redistribution claim for quarantined (REFERENCE_ONLY) source
