...
# GNURUST.VALID-PROGRAMS.GNUCOBOL-TESTSUITE.1 — valid-program corpus -- the GnuCOBOL Autotest suite is classified at AT_CHECK-step level (valid-programs.json + discovered-steps.json + summary.md exist and reconcile)

**Verdict: PASS** · replay `PASS=1 FAIL=0 valid-testsuite`
