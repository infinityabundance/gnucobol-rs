...
claimed_now:
  ...
  - id: set-88-true
    what: SET condition-name TO TRUE canonical parent bytes (first VALUE / range lower bound), matching cobc
    scope: alnum/numeric/COMP-3 parents; output satisfies eval_88 (GNURUST.12)
  - id: copy-expansion
