...
- surfaces: **42**  ·  sealed ✅ **26**  ·  observed 🟡 11  ·  refused ⛔ 5  ·  **missing ❌ 0**

- sealed fraction (data-representation spine): **26/42**
...
| `file-io-sequential` | file I/O | `fileio.c` | ✅ sealed | GNURUST.FILE.SEQUENTIAL.1, GNURUST.FILE.WRITE.1, GNURUST.FILE.REWRITE.1, GNURUST.FILEIO.LINESEQ.1, GNURUST.FILEIO.LINESEQ.2, GNURUST.FILEIO.SEQ.1 |
