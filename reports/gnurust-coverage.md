...
| `screen-section` | screen I/O (native, terminal-byte reproduction) | `screenio.c` | 🟡 observed | GNURUST.SCREENIO.INIT.1, GNURUST.SCREENIO.DISPLAY.2, GNURUST.SCREENIO.DISPLAY.3 |
