<!--
DO NOT EDIT BY HAND. Generated by lab/docs/generate.py from docs-src/archaeology-atlases-j-standard-release-join-atlas-hidden-surfaces.model.json
...
Evidence authority: the claim-ladder + generated casefiles. Legacy source preserved (lossless) under research/legacyreports/archaeology/atlases/J-standard-release-join-atlas/hidden-surfaces.md (sha256 749eff08e5bc70fbab5322799352deb899664bc49ac875f332818a6234b08ca7).
-->

# Hidden / not-well-known surfaces the join surfaces

> _Generated document (TRUST.4.DOCS). Machine authority: `reports/claim-ladder.json` + `reports/casefiles/`. Legacy source preserved losslessly under `research/legacyreports/archaeology/atlases/J-standard-release-join-atlas/hidden-surfaces.md`._
